...
import 'package:flutter_web_course/pages/finance/widgets/cara-bayar/form_carabayar.dart';
import 'package:flutter_web_course/pages/finance/widgets/cara-bayar/table_carabayar.dart';
...
class FinanceCaraBayar extends StatefulWidget {
  const FinanceCaraBayar({Key key}) : super(key: key);

  @override
  State<FinanceCaraBayar> createState() => _FinanceCaraBayarState();
}

class _FinanceCaraBayarState extends State<FinanceCaraBayar> {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TableCaraBayar(listCaraBayar: listCaraBayar)
                  ],
                ),
              ))
        ],
