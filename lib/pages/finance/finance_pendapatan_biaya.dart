...
class FinancePendapatanBiaya extends StatefulWidget {
  const FinancePendapatanBiaya({Key key}) : super(key: key);

  @override
  State<FinancePendapatanBiaya> createState() => _FinancePendapatanBiayaState();
}

class _FinancePendapatanBiayaState extends State<FinancePendapatanBiaya> {
  List<Map<String, dynamic>> listPendapatanBiaya = [];
  ...
  void getData() async {
    var response = await http
        .get(Uri.parse("$urlAddress/finance/all-pendapatan-biaya"), headers: {
      'pte-token': kodeToken,
    });
      ...
      onPressed: () async {
        authInqu == '1'
            ? showDialog(
                context: context,
                builder: (context) =>
                    ModalCdPendapatanBiaya(idBiaya: idBiaya, tambah: tambah))
            : showDialog(
                context: context,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (value) {
                                if (value == '') {
                                  ...
                                  setState(() {
                                    listPendapatanBiaya = listPendapatanBiaya
                                        .where(((element) =>
                                            element['DESKRIPSI']
                                                .toString()
                                                .toUpperCase()
                ...
                TablePendapatanBiaya(listBiaya: listPendapatanBiaya)
              ],
            ),
          )
        ],
