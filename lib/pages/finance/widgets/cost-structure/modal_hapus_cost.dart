...
class ModalHapusCostStructure extends StatelessWidget {
  String idBiaya;

  ModalHapusCostStructure({Key key, @required this.idBiaya}) : super(key: key);
                ...
                children: [
                  ElevatedButton(
                      onPressed: () {
                        ...
                        HttpCostStructure.deleteCostSructure(idBiaya)
                            .then((value) {
                          if (value.status == true) {
                            ...
                            navigationController
                                .navigateTo('/finance/cost-structure');
                          }
                        });
                      },
