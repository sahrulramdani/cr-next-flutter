...
class KasPendapatan extends StatefulWidget {
  const KasPendapatan({Key key}) : super(key: key);

  @override
  State<KasPendapatan> createState() => _KasPendapatanState();
}

class _KasPendapatanState extends State<KasPendapatan> {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Expanded(
                        child: TablePendapatan(listPendapatan: listPendapatan))
                  ],
                ),
              ),
            ))
