...
class RevenueFinanceSmall extends StatefulWidget {
  const RevenueFinanceSmall({Key key}) : super(key: key);

  @override
  State<RevenueFinanceSmall> createState() => _RevenueFinanceSmallState();
}

class _RevenueFinanceSmallState extends State<RevenueFinanceSmall> {
  int BULAN_JAN;
  int BULAN_FEB;
  int BULAN_MAR;
  int BULAN_APR;
