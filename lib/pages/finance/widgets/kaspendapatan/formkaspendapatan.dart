...
class FormKasPendapatan extends StatefulWidget {
  const FormKasPendapatan({Key key}) : super(key: key);

  @override
  State<FormKasPendapatan> createState() => _FormKasPendapatanState();
}

class _FormKasPendapatanState extends State<FormKasPendapatan> {
  List<Map> objBarang = [];
        ...
        children: [
          Row(
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () {
                  menuController.changeActiveitemTo('Kas Pendapatan');
                  navigationController.navigateTo('/finance/kas-pendapatan');
                },
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: Color.fromARGB(200, 187, 214, 184),
                            ),
                            child: Padding(
