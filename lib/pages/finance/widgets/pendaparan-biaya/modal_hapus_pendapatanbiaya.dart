...
class ModalHapusPendapatanBiaya extends StatelessWidget {
  String idBiaya;

  ModalHapusPendapatanBiaya({Key key, @required this.idBiaya})
      : super(key: key);
                ...
                children: [
                  ElevatedButton(
                      onPressed: () {
                        ...
                        HttpKompPendapatan.deleteKompPendapatan(idBiaya)
                            .then((value) {
                          if (value.status == true) {
                            ...
                            navigationController
                                .navigateTo('/finance/master-pendapatan-biaya');
                          }
                        });
                      },
