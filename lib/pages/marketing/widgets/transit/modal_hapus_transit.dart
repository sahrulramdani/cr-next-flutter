...
class ModalHapusTransit extends StatelessWidget {
  String idTransit;

  ModalHapusTransit({Key key, @required this.idTransit}) : super(key: key);
                ...
                children: [
                  ElevatedButton(
                      onPressed: () {
                        ...
                        HttpTransit.deleteRuteTransit(idTransit).then((value) {
