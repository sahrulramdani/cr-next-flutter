...
class ModalHapusPengguna extends StatelessWidget {
  String idPengguna;

  ModalHapusPengguna({Key key, @required this.idPengguna}) : super(key: key);
                ...
                children: [
                  ElevatedButton(
                      onPressed: () {
                        ...
                        HttpPengguna.deletePengguna(idPengguna).then((value) {
                          if (value.status == true) {
                            ...
                            menuController
                                .changeActiveitemTo('Daftar Pengguna');
                            navigationController
                                .navigateTo('/setting/daftar-pengguna');
                          } else {
                            showDialog(
                                context: context,
                                builder: (context) => const ModalDeleteFail());
                          }
                        });
                      },
