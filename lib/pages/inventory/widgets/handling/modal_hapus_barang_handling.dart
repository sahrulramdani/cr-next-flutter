...
class ModalHapusBarangHandling extends StatelessWidget {
  String idGrup;
  String idBarang;

  ModalHapusBarangHandling({
    Key key,
                ...
                children: [
                  ElevatedButton(
                      onPressed: () {
                        ...
                        HttpGrupHandling.deleteGrupHandlingDetail(
                          idGrup,
                          idBarang,
                        ).then((value) {
                          if (value.status == true) {
                            ...
                            menuController
                                .changeActiveitemTo('Master Handling');
                            navigationController
                                .navigateTo('/inventory/master-handling');
                          }
                        });
                      },
