...
class RevenueInfoLarge extends StatefulWidget {
  const RevenueInfoLarge({Key key}) : super(key: key);

  @override
  State<RevenueInfoLarge> createState() => _RevenueInfoLargeState();
}

class _RevenueInfoLargeState extends State<RevenueInfoLarge> {
  int BULAN_JAN;
  int BULAN_FEB;
  int BULAN_MAR;
  int BULAN_APR;
