...
class ModalHapusAccount extends StatelessWidget {
  // final String idAgency;
  String idAccount;

  ModalHapusAccount({Key key, @required this.idAccount}) : super(key: key);
                ...
                children: [
                  ElevatedButton(
                      onPressed: () {
                        ...
                        HttpAccount.deleteAccount(idAccount).then((value) {
                          if (value.status == true) {
                            ...
                            navigationController
                                .navigateTo('/finance/master-account');
                          }
                        });
                      },
