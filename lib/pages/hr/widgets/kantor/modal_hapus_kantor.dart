...
class ModalHapusKantor extends StatelessWidget {
  String idKantor;

  ModalHapusKantor({Key key, @required this.idKantor}) : super(key: key);
                ...
                children: [
                  ElevatedButton(
                      onPressed: () {
                        ...
                        HttpKantor.deleteKantor(idKantor).then((value) {
                          if (value.status == true) {
                            ...
                            navigationController.navigateTo('/hr/hotel');
                          } else {
                            showDialog(
                                context: context,
