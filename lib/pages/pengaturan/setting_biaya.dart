...
import 'package:flutter_web_course/pages/pengaturan/widget/biaya/form_biaya.dart';
import 'package:flutter_web_course/pages/pengaturan/widget/biaya/table_biaya.dart';
import 'package:flutter_web_course/widgets/custom_text.dart';
import 'package:get/get.dart';
import 'package:flutter_web_course/constants/style.dart';
import 'package:http/http.dart' as http;

class SettingBiaya extends StatefulWidget {
  const SettingBiaya({Key key}) : super(key: key);

  @override
  State<SettingBiaya> createState() => _SettingBiayaState();
}
          ...
          Obx(() => Row(
                children: [
                  Container(
                    ...
                    child: CustomText(
                      text: 'Setting - ${menuController.activeItem.value}',
                      size: 24,
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TableBiaya(listBiaya: listBiaya)
                  ],
                ),
              ))
        ],
