...
class _PrintAlbumState extends State<PrintAlbum> {
  ...
  Future<void> _createPDF() async {
                                            ...
                                            children: [
                                              pw.Text(
                                                  ...
                                                  style: pw.TextStyle(
                                                      ...
                                                      fontWeight:
                                                          pw.FontWeight.bold)),
                                              pw.Text('02 MAR s/d 10 MAR 2023',
                                                  style: pw.TextStyle(
                                                      fontSize: 8,
                                                      fontWeight:
                                                          pw.FontWeight.bold))
                                                ...
                                                child: pw.Table.fromTextArray(
                                                    ...
                                                    data: <List>[
                                                      ...
                                                      [
                                                        "TMPT TGL LHR",
                                                        ":",
                                                        "${listPelanggan[0]['TMPT_LHIR']}, ${fncGetTanggal(DateFormat("dd-MM-yyyy").format(DateTime.parse(listPelanggan[0]['TGLX_LHIR'])))}"
                                                      ],
                                                      [
                                                        "TELP	",
                                                        ":",
    ...
    AnchorElement(
      ...
      ..setAttribute("download", "nametag_paspor_${widget.keberangkatan}.pdf")
      ..click();
  }
