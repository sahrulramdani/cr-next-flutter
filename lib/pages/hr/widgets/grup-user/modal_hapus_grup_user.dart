...
class ModalHapusGrupUser extends StatelessWidget {
  String idGrup;

  ModalHapusGrupUser({Key key, @required this.idGrup}) : super(key: key);
                ...
                children: [
                  ElevatedButton(
                      onPressed: () {
                        ...
                        HttpGrupMenu.deleteGrupMenu(idGrup).then((value) {
