...
class ModalHapusBandara extends StatelessWidget {
  String idBandara;

  ModalHapusBandara({Key key, @required this.idBandara}) : super(key: key);
                ...
                children: [
                  ElevatedButton(
                      onPressed: () {
                        ...
                        HttpBandara.deleteBandara(idBandara).then((value) {
