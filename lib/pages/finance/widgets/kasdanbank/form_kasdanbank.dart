...
class KasDanBankForm extends StatefulWidget {
  const KasDanBankForm({Key key}) : super(key: key);

  @override
  State<KasDanBankForm> createState() => _KasDanBankFormState();
}

class _KasDanBankFormState extends State<KasDanBankForm> {
  ...
  fncSaveData() async {
    ...
    var response1 = await http.get(
        Uri.parse("$urlAddress/finance/kas-bank/generate-number"),
        headers: {
          'pte-token': kodeToken,
        });
