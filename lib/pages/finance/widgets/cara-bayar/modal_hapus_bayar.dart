...
class ModalHapusCaraBayar extends StatelessWidget {
  // final String idAgency;
  String idKasBank;

  ModalHapusCaraBayar({Key key, @required this.idKasBank}) : super(key: key);
                ...
                children: [
                  ElevatedButton(
                      onPressed: () {
                        ...
                        HttpKasBank.deleteKasBank('TYPE_BYRX', idKasBank)
                            .then((value) {
                          if (value.status == true) {
                            ...
                            menuController
                                .changeActiveitemTo('Pembuatan Cara Bayar');
                            navigationController
                                .navigateTo('/finance/pembuatan-carabayar');
                          }
                        });
                      },
