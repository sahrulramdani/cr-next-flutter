...
// ignore_for_file: unused_import, missing_return, deprecated_member_use
...
class FormPendaftaranBackup extends ResponsiveWidget {
  const FormPendaftaranBackup({Key key}) : super(key: key);

  @override
  Widget buildDesktop(BuildContext context) =>
      const DesktopFormPendaftaranBackup();
...
class DesktopFormPendaftaranBackup extends StatefulWidget {
  const DesktopFormPendaftaranBackup({Key key}) : super(key: key);

  @override
  State<DesktopFormPendaftaranBackup> createState() =>
      _DesktopFormPendaftaranBackupState();
}

class _DesktopFormPendaftaranBackupState
    extends State<DesktopFormPendaftaranBackup> with TickerProviderStateMixin {
  ...
  Widget inputNamaJadwal() {
    ...
    return SizedBox(
      ...
      child: DropdownSearch(
        ...
        dropdownBuilder: (context, selectedItem) =>
            Text(paket ?? "Jadwal Belum dipilih"),
        validator: (value) {
          if (idProduk == null) {
  ...
  Widget inputPaspor() {
    ...
    return SizedBox(
      ...
      child: DropdownSearch(
        ...
        dropdownBuilder: (context, selectedItem) =>
            Text(pembuatan ?? "Pilih Paspor"),
        validator: (value) {
          if (pembuatan == null) {
            return "Paspor masih kosong !";
          }
        },
      ),
    );
  ...
  Widget inputVaksin() {
    ...
    return SizedBox(
      ...
      child: DropdownSearch(
        ...
        dropdownBuilder: (context, selectedItem) =>
            Text(vaksin ?? "Pilih Vaksin"),
        validator: (value) {
          if (vaksin == null) {
            return "Vaksin masih kosong !";
          }
        },
      ),
    );
  ...
  Widget inputKamar() {
    ...
    return SizedBox(
      ...
      child: DropdownSearch(
        ...
        dropdownBuilder: (context, selectedItem) =>
            Text(kamar ?? "Pilih Kamar"),
        validator: (value) {
          if (kamar == null) {
            return "Kamar masih kosong !";
          }
        },
      ),
    );
    ...
    HttpPendaftaran.savePendaftaran(
      ...
      if (value.status == true) {
        ...
        navigationController
            .navigateTo("/pendaftaran/${Get.parameters['kode']}");
          ...
          : Column(
              ...
              children: [
                ...
                Container(
                  ...
                  width:
                      screenWidth < 550 ? screenWidth * 0.9 : screenWidth * 0.7,
                  child: TabBarView(
                    controller: tabController,
                    children: [
                      ...
                      SingleChildScrollView(
                        scrollDirection: Axis.vertical,
                        child: DataDiriContent(
                          ktpPelangganByte: ktpPelangganByte,
                          nik: nik,
                          nama: namaJamaah,
                          jk: jk,
                          tempatLahir: tempatLahir,
                          tanggalLahir: dateLahir.text,
                          alamat: alamat,
...
// class MobileFormPendaftaranBackup extends StatelessWidget {
//   const MobileFormPendaftaranBackup({Key key}) : super(key: key);
