...
class PrintNametagPaspor extends StatefulWidget {
  final List<Map<String, dynamic>> listPelangganJadwal;

  const PrintNametagPaspor({Key key, @required this.listPelangganJadwal})
      : super(key: key);

  @override
  State<PrintNametagPaspor> createState() => _PrintNametagPasporState();
}

class _PrintNametagPasporState extends State<PrintNametagPaspor> {
  ...
  Future<void> _createPDF() async {
    ByteData byteData =
        await rootBundle.load('assets/images/nametag_paspor_background.png');
    ...
    int pages = (listPelanggan.length / 18).toInt() + 1;
    int arrData = 0;
    // Maksimal index data
                        ...
                        children: [
                          pw.Container(
                              child: pw.GridView(
                                  ...
                                  children: [
                                for (var i = (arrData + ((a - 1) * 18));
                                    i < (a != pages ? (a * 18) : maxData);
                                    i++)
                                  pw.Container(
